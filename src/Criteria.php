...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'name', 'priority', 'strategy', 'match', 'providers', 'active', 'created_at' ];
    }
    ...
    {
        return [ 'id', 'name', 'priority', 'strategy', 'active', 'created_at' ];
    }
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\KmsRoutingPolicies\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\KmsRoutingPolicies\Definitions::softDeleteColumn();
