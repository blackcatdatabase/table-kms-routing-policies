...
final class KmsRoutingPoliciesModule implements ModuleInterface
{
    public function name(): string { return 'table-kms_routing_policies'; }
    public function table(): string { return 'kms_routing_policies'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_kms_route_active' ];
        if ($d->isMysql()) {
