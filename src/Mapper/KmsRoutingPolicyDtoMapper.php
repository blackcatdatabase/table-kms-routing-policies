...
namespace BlackCat\Database\Packages\KmsRoutingPolicies\Mapper;

use BlackCat\Database\Packages\KmsRoutingPolicies\Dto\KmsRoutingPolicyDto;
use BlackCat\Database\Packages\KmsRoutingPolicies\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO KmsRoutingPolicyDto:
...
final class KmsRoutingPolicyDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'priority' ];
    /** @var string[] */
    private const FLOAT_COLS  = [];
    /** @var string[] */
    private const JSON_COLS   = [ 'match', 'providers' ];
    /** @var string[] */
     ...
     * @return KmsRoutingPolicyDto
     */
    public static function fromRow(array $row): KmsRoutingPolicyDto
    {
        /** @var KmsRoutingPolicyDto */
        return DtoHydrator::fromRow(
            KmsRoutingPolicyDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?KmsRoutingPolicyDto
    {
     ...
     *
     * @param KmsRoutingPolicyDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(KmsRoutingPolicyDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(KmsRoutingPolicyDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(KmsRoutingPolicyDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,KmsRoutingPolicyDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,KmsRoutingPolicyDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(KmsRoutingPolicyDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,KmsRoutingPolicyDto>
     */
