...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'kms_routing_policies'; }
    public static function contractView(): string { return 'vw_kms_routing_policies'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'name', 'priority', 'strategy', 'match', 'providers', 'active', 'created_at' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'name' ], [ 'constraint' ], [ 'id' ] ]; }

    /** @return string[] JSON columns for casts/operations */
    public static function jsonColumns(): array { return [ 'match', 'providers' ]; }

    /** @return string[] List of numeric columns (generator heuristic; no runtime DB queries). */
    public static function intColumns(): array { return [ 'id', 'priority' ]; }
