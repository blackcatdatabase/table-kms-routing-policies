...
use BlackCat\Database\Packages\KmsRoutingPolicies\Repository\KmsRoutingPolicyRepository;
...
{
    private KmsRoutingPolicyRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new KmsRoutingPolicyRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\KmsRoutingPolicies\Dto\KmsRoutingPolicyDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\KmsRoutingPolicies\Dto\KmsRoutingPolicyDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\KmsRoutingPolicies\Dto\KmsRoutingPolicyDto|null
    {
