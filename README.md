...
<div style='font-size:13px;opacity:0.92;'>Lineage heat: 0 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII: 1 · Changelog: fresh (18 d)</div>
</div>
...
- Pkg folder: [packages\kms-routing-policies](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\kms-routing-policies)
...
graph LR
  ...
  kms_routing_policies["kms_routing_policies"]:::center
```
...
| Engine | Support |
| --- | --- |
| mysql | ✅ schema(3)<br/>✅ views(2)<br/>⚠️ seeds |
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package kms-routing-policies -Apply
