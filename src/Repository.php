...
namespace BlackCat\Database\Packages\KmsRoutingPolicies;
...
use BlackCat\Database\Packages\KmsRoutingPolicies\Repository\KmsRoutingPolicyRepository as GeneratedRepository;
...
{
  private KmsRoutingPolicyRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof KmsRoutingPolicyRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected KmsRoutingPolicyRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\KmsRoutingPolicies\Dto\KmsRoutingPolicyDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\KmsRoutingPolicies\Dto\KmsRoutingPolicyDto|null { return $this->repo->getById($id, $asDto); }
